...
// ---- /api/check (teacher-only writing checker) -----------------------------
//
// Proxies the essay to LanguageTool's public API and returns the mistakes it
// finds, so the teacher's "View essays" view can underline them. Teacher-key
// gated: students can never reach it. Note this sends the essay text to
