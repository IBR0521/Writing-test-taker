...
<body>
  ...
  <!-- One-time note from the developer, shown once on this browser. -->
  <div id="devNoteTip" class="tip-toast hidden" role="status" aria-live="polite">
    <span class="tip-ico" aria-hidden="true"><svg class="ico ico-lg" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 5.5A2 2 0 015.5 3.5h9a2 2 0 012 2v6a2 2 0 01-2 2H9l-3.5 3v-3H5.5a2 2 0 01-2-2v-6z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg></span>
    <div class="tip-body">
      <p class="tip-title">Students and Teachers</p>
      <p class="tip-text">If you are dealing with any kind of problem, or have any kind of suggestion related to the platform, please write it down in the <b>Suggestions &amp; problems</b> section below. The developer reads and considers every suggestion, and will try to make the platform as good as possible for your use.</p>
    </div>
    <button id="devNoteTipDismiss" class="tip-close" aria-label="Dismiss tip">Got it</button>
  </div>
